...
api.defaults.headers.common['X-API-KEY'] = 'live_aewPMMJLFtfEoY5ahdM0czx8m6Xjhqp2EYyVa6w1E5VctVK4Uc4LYCAhSg70MBou';
...
async function loadFavouriteMichis() {
    const res = await fetch(API_URL_FAVOTITES, {
        method: 'GET',
        headers: {
            'X-API-KEY': 'live_aewPMMJLFtfEoY5ahdM0czx8m6Xjhqp2EYyVa6w1E5VctVK4Uc4LYCAhSg70MBou',
        },
    });
    const data = await res.json();
